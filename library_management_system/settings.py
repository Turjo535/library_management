...
SECRET_KEY = 'django-insecure-%%cn!j-gc46p-@+8pn8exm%_k)jqnjp0(4+92niubs69j3t(99'
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:3000', 'http://localhost', 'http://127.0.0.1']  # Add your frontend origins
CSRF_COOKIE_SECURE = False  # Set to False for local development
CSRF_USE_SESSIONS = False  # Set to False for local development